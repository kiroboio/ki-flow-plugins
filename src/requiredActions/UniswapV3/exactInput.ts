...
export const UniswapV3ExactInput = createRequiredActionForPlugin({
  plugin: UniswapV3.exactInput,
  requiredActions(args) {
    ...
    if (isVariableOrUndefined(amountIn) || isVariableOrUndefined(args.contractAddress) || isVariableOrUndefined(path))
      return [];
